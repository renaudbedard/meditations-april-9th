...
namespace MiniEngineAO
{
    ...
    public sealed class AmbientOcclusion : MonoBehaviour
    {
        ...
        [SerializeField, Range(0, 17)] int _debug = 0;
        ...
        [SerializeField, HideInInspector] ComputeShader _downsample1Compute = null;
        [SerializeField, HideInInspector] ComputeShader _downsample2Compute = null;
        [SerializeField, HideInInspector] ComputeShader _renderCompute = null;
        [SerializeField, HideInInspector] ComputeShader _upsampleCompute = null;
